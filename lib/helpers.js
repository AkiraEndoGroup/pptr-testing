module.exports = {
  ...
  typeText: async function(page, text, selector) {
    try {
      ...
      throw new Error(`Could not type text into seletor: ${selector}`)
    }
  },
  ...
  getCount: async function(page, selector) {
    try {
      ...
      throw new Error(`Cannot get count of selevtor: ${selector}`)
    }
  },
  ...
  waitForText: async function(page, selector, text) {
    try {
      ...
      throw new Error(`Text: ${text} not found for selector`)
    }
  },
